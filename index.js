...
// Limpieza de inicialización Google Auth y Drive
...
// Hacer accesible para google-auth.js
window.renderDriveBackupInfo = renderDriveBackupInfo;

// Inicialización de Google Auth y Drive solo una vez
window.addEventListener('DOMContentLoaded', () => {
    ...
    renderFilterTags();
    renderDriveBackupInfo();
    // Inicializar Google Auth (esto intentará login silencioso si corresponde)
    initGoogleAuth();
});
...
document.getElementById('drive-delete-btn').onclick = deleteDriveBackup;